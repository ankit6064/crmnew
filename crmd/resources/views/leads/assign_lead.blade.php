    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" id="modelclose" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="NoResponseData">
                        <div class="form-group" id="employe" name="employe">
                            ...
                            <input type="hidden" name="previous_user_id" value="">
                            <input type="hidden" name="total_leads" value="">
...
<script>
        ...
        $(document).on('click','#save-data-reassigned',function () {
             ...
             if(ReassignedCustomer == ''){
                ...
                $.ajax({
                    type: 'GET',
                    dataType: "html",
                    data: {camp_id:$("[name=camp_id]").val(),user_id:$("[name=previous_user_id]").val(),new_id:ReassignedCustomer ,leads:$("[name=total_leads]").val()},
    ...
    function reassign(){
                ...
                $("[name=camp_id]").val();
                $("[name=previous_user_id]").val();
                $("[name=total_leads]").val();
                var id = $(this).attr('data-asign');
                var camp_id = $(this).attr('data-id');
                var total_leads = $(this).attr('data-total')
                ...
                setTimeout(function(){ 
                    ...
                    $(".ReassignedCustomer option").each(function()
                    {
                        if($(this).val() == id){
                           ...
                           $("[name=camp_id]").val(camp_id);
                           $("[name=previous_user_id]").val(id);
                           $("[name=total_leads]").val(total_leads);
                        }
