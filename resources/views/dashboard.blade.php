...
<div class="main-right managersubmanagerclass">
    <div class="right-side">
        ...
        <div class="row first-card">
            ...
            <div class="col-md-3">
                <a href="{{ route('manager.index') }}" class="stat-card-link" style="text-decoration:none; color:inherit;">
                    <div class="stat-card">
            ...
            <div class="col-md-3">
                <a href="{{ route('employee.index') }}" class="stat-card-link" style="text-decoration:none; color:inherit;">
                    <div class="stat-card">
                        <div class="card-header">
            ...
            <div class="col-md-3">
                <a href="{{ route('sources.index') }}" class="stat-card-link" style="text-decoration:none; color:inherit;">
                    <div class="stat-card">
                        <div class="card-header">
        ...
        <div class="row second-card">
            ...
            <div class="col-md-3">
                <a href="{{ route('allleadview') }}" class="stat-card-link" style="text-decoration:none; color:inherit;">
                    <div class="stat-card">
                        <div class="card-header">
                            <h4>Total Leads</h4>
