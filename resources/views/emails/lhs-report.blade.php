    ...
    <section class="Prospect_sec">
        <div class="container">
            ...
            <table style="width:100%; border: 1px solid #000 !important; border-collapse: collapse;">
                <tr>
                    <th
                        style="width:15%; background-color: #fff; font-size: 13px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left;  border-left: 2px solid black;">
                        Contact's Name:</th>
                    <td
                    ...
                    <th
                        ...
                        Board Number:</th>
                    <td
                        style="width:35%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-right: 2px solid black">
                        {{ $data['lhsreport']->board_no }}
                    </td>
                </tr>
                <tr>
                    <th
                        style="width:15%; background-color: #c9d8fe; font-size: 13px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left;  border-left: 2px solid black;">
                    ...
                    <th
                        ...
                        Direct Number:</th>
                    <td
                        style="width:35%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; background-color: #c9d8fe; border-right: 2px solid black">
                ...
                <tr>
                    <th
                        style="width:15%; background-color: #fff; font-size: 13px; border: 1px solid black; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-left: 2px solid black">
                        Address:</th>
                    <td
                        style="width:35%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left;">
                ...
                <tr>
                    ...
                    <th
                        ...
                        Website:</th>
                    <td
                        style="width:35%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; background-color: #fff; border-right: 2px solid black">
            ...
            <table style="width:100%; border: 1px solid black; border-collapse: collapse;">
                <tr>
                    <td
                        style="width:35%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-left: 2px solid black; border-right: 2px solid black">
            ...
            <table style="width:100%; border: 1px solid black; border-collapse: collapse;">
                <tr>
                    <th
                        style="width:20%; background-color: #fff; font-size: 13px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-left: 2px solid black">
                        Responsibilities:</th>
                    <td
                        style="width:80%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-right: 2px solid black">
                        {!! $data['lhsreport']->responsibilities !!}
                    </td>
                </tr>
                <tr>
                    <th
                        style="width:20%; background-color: #c9d8fe; font-size: 13px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-left: 2px solid black">
                        Team Size:</th>
                    <td
                        style="width:80%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left;     background-color: #c9d8fe; border-right: 2px solid black;">
            ...
            <table style="width:100%; border: 1px solid black; border-collapse: collapse;">
                <tr>
                    <td
                        style="width:60%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; font-weight: bold; border-left: 2px solid black">
                        Does the prospect wish to have a Face to Face meeting or teleconference?</td>
                    <td
                        style="width:60%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-right: 2px solid black;">
                        {{ $data['lhsreport']->meeting_teleconference }}
                    </td>
                </tr>
                <tr>
                    <td
                        style="width:60%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; background-color: #c9d8fe;font-weight: bold; border-left: 2px solid black">
                        Is the contact the decision maker? If No, then who is?</td>
                    <td
                        style="width:60%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; background-color: #c9d8fe; border-right: 2px solid black;">
            ...
            <table style="width:100%; border: 1px solid black; border-collapse: collapse;">
                <tr>
                    ...
                    <td
                        style="width:30%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; border-right: 2px solid black;">
                ...
                <tr>
                    ...
                    <td
                        style="width:30%; font-size: 12px; border: 1px solid black; border-collapse: collapse; padding: 10px; text-align: left; background-color: #c9d8fe; border-right: 2px solid black;">
