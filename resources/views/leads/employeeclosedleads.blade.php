...
@push('scripts')
    ...
    var table = $('#example23').DataTable({
        ...
        columns: [
            ...
            { data: 'source_name', name: 'source_name', orderable: true },
            { data: 'description', name: 'description', orderable: true },
            { data: 'company_name', name: 'company_name', orderable: true },
            { data: 'prospect_first_name_new', name: 'prospect_first_name',orderable:true },
            ...
            { data: 'updated_at_new', name: 'closed_on',orderable:true }
        ],
