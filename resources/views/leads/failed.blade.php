    ...
    <div class="main-right">
        ...
        <div class="row">
                <div class="row align-items-center mb-3">
                    <div class="col-md-8">
                        <h2 class="mb-0">Failed Leads Listing</h2>
                    </div>

                    <div class="col-md-4 text-end">
                        <button type="button" class="btn return-btn"
                            onclick="window.history.back() || (window.location.href='/employeedashboard');">
            ...
            <div class="graph campaignslist logstable lead-listing failed-leads">
                <div class="table">
