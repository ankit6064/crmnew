            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="m-b-0 text-white">Employee Logs</h4>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#employeelogs').DataTable({
                ...
                columns: [
                    { data: 'employeename', name: 'employeename', orderable: true, searchable: false },
                ...
                order: [[5, 'desc']] // index 5 is 'created_at' column, descending
