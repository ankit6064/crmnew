...
@section('content')
    ...
    <style>
        ...
        div#employee-table_filter input[type="search"] {
    ...
    <div class="main-right">
        <div class="right-side">
            <h2>{{ $managerName->full_name ?? 'Manager Not Found' }} - Employees</h2>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button style="background-color:#192e62;color:#fff;border-radius:3px"
                                onclick="transfer();">Assign Campaign</button>
                            <button style="background-color:#192e62;color:#fff;border-radius:3px"
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-info" data-dismiss="modal" onclick="closemodalemp()">Skip
                                for Now</button>
                        </div>
                    </div>
                </div>
