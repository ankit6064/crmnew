...
@section('content')
  ...
  <style>
    ...
    .graph tbody tr.odd tr.even td:last-child {
      gap: 11px;
      align-items: unset;
    }
  </style>
  ...
  <div class="main-right">
    ...
    <div class="row">
                <div class="row align-items-center mb-3">
                    <div class="col-md-8">
                        <h2 class="mb-0">Manager Listing</h2>
                    </div>
    ...
    $(document).ready(function () {
      ...
      var table = $('#employee-table').DataTable({
        ...
        columns: [
          ...
          { data: 'orignal_password', name: 'orignal_password' },
      ...
      $('.filter-card').on('click', function () {
        ...
        if (currentStatus === selectedFilter) {
