    ...
    <div class="sidebar">
        ...
        <div class="menu-item dropdown {{ $isLeadsActive ? 'open' : '' }}">
            ...
            <div class="submenu">
                ...
                <a href="{{ route('meeting_scheduled') }}"
                    class="{{ request()->routeIs('meeting_scheduled') ? 'active' : '' }}">
                    <i class="fa-solid fa-calendar-check"></i> Active Meetings
                </a>
        ...
        <div class="menu-item dropdown {{ $isLogsActive ? 'open' : '' }}">
            ...
            <div class="submenu">
                <a href="{{ route('employeelogs') }}" class="{{ request()->routeIs('employeelogs') ? 'active' : '' }}">
    ...
    <div class="sidebar">
        ...
        <div class="menu-item dropdown {{ request()->is('leads/*') ? 'active' : '' }}">
            ...
            <div class="submenu">
                ...
                <a href="{{ route('leads.create') }}" class="{{ request()->is('leads/create') ? 'active' : '' }}">
                    <i class="fa-solid fa-user-plus"></i> Add Lead
                </a>
...
@else
    ...
    <div class="sidebar">
        ...
        <!-- Dashboard -->
        <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'active' : '' }} menu-link">
